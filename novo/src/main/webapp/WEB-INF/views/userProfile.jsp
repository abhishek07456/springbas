...
li.active>a {
    background-color: #f3935be8 !important;
...
.form-control, .is-focused .form-control {
    background-image: linear-gradient(to top,  #f3935be8 2px, rgba(156, 39, 176, 0) 2px), linear-gradient(to top, #d2d2d2 1px, rgba(210, 210, 210, 0) 1px) !important;
}

</style>
<head>
  <meta charset="utf-8" />
  <link rel="apple-touch-icon" sizes="76x76" href="${pageContext.request.contextPath}/resources/img/novo.jpg">
  <link rel="icon" type="image/png" href="${pageContext.request.contextPath}/resources/img/novo.jpg">
...
<body class="">
  <div class="wrapper ">
    <div class="sidebar" data-color="purple" data-background-color="white" data-image="${pageContext.request.contextPath}/resources/img/sidebar-1.jpg">
      <!--
    ...
    -->
      <div class="logo">
      <center>
        <img src="${pageContext.request.contextPath}/resources/img/novo.jpg" class="simple-text logo-normal" style="width: 23%;">
         NovoInvent
        </center>
      </div>
      <div class="sidebar-wrapper">
        <ul class="nav">
          ...
          <li class="nav-item ">
            <a class="nav-link" href="./attendence_list.html">
          ...
          <li class="nav-item ">
            <a class="nav-link" href="./food_token.html">
          ...
          <li class="nav-item ">
            <a class="nav-link" href="./rtl.html">
              <i class="material-icons">language</i>
              <p>Reimbursment Details</p>
            </a>
          </li>
          <li class="nav-item ">
            <a class="nav-link" href="./rtl.html">
              <i class="material-icons">language</i>
              <p>Comp Off Details</p>
            </a>
          </li>
        </ul>
      </div>
      ...
      <div class="content">
        <div class="container-fluid">
          <div class="row">
            <div class="col-md-8">
              <div class="card">
                <div class="card-header card-header-primary" style="background: #f3935be8 !important;">
                  <h4 class="card-title">Edit Profile</h4>
                  <p class="card-category">Complete your profile</p>
                </div>
                <div class="card-body">
                  <form:form  method="POST" action="profile" modelAttribute="signup">
                    <div class="row">
                      <div class="col-md-5">
                        <div class="form-group">
                          <label class="bmd-label-floating">NovoInvent</label>
            ...
            <div class="col-md-4">
              <div class="card card-profile">
                <div class="card-avatar">
                  <a href="#pablo">
                    <img class="img" src="${pageContext.request.contextPath}/resources/img/faces/marc.jpg" />
                  </a>
                </div>
                <div class="card-body">
                  <h6 class="card-category text-gray">full stack developer</h6>
                  <h4 class="card-title">${signup.firstName} ${signup.lastName} </h4>
                  <p class="card-description">
                   </p>
                  <a href="#pablo" class="btn btn-primary btn-round">upload image</a>
                </div>
              </div>
            </div>
          </div>
