...
.form-control, .is-focused .form-control {
    background-image: linear-gradient(to top,  #f3935be8 2px, rgba(156, 39, 176, 0) 2px), linear-gradient(to top, #d2d2d2 1px, rgba(210, 210, 210, 0) 1px);
}
          ...
          <div class="row">
            <div class="col-md-8">
              <div class="card">
                ...
                <div class="card-body">
                  <form:form action="profile" modelAttribute="signup">
                    <div class="row">
                    
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Phone No</label>
                          <form:input type="text" cssClass="form-control" path="phoneNo"/>
                        </div>
                      </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <form:input type="text" cssClass="form-control" path="middleName"/>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">User Type</label>
                          <form:select  cssClass="form-control" path="userAccess" multiple="false">
                         <form:options items="${signup.usertype}" />
                         </form:select>
